...
**DiagramMD** is the canonical diagram syntax of the LearnSpec suite.

A `.diagram.md` file is valid Markdown — readable by humans, versionable in Git, and consumable by any compatible LearnSpec player. It defines all diagram block types usable across the suite (Mermaid, TikZ, Graphviz, PlantUML, chess, abc, smiles, vega-lite…) and supports standalone reusable diagram files.
